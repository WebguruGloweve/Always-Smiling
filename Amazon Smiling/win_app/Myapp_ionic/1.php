...
abstract class AbstractCartographyController extends AbstractActionController
{
        ...
        if ($templates) {
            ...
            if ($emptyOption) {
                $templates = array_merge(
                    [['placeholder' => $this->translate('Select typeâ€¦')]], // @translate
                    $templates
                );
            }
        }
    ...
    /**
     * Search geometries from a query.
     *
     * Note: Metadata are simplified for the display and use in leaflet.
     *
     * @return JsonModel
    ...
    public function searchAction()
    {
        ...
        // Check media id to avoid to mix results from image (geometry) or map
        // (geography).
        if (empty($query['mediaId'])) {
            $query['mediaId'] = 0;
        }

        // Limit to a number of result.
        // Search by metadata (don't forget mediaId.
        if (!empty($query['search'])) {
            // Here, we search annotations, not items;
            $response = $this->api()->search('annotations', $query);
            $annotations = $response->getContent();
            foreach ($annotations as $annotation) {
                // TODO $this->fetchSimpleGeometries($annotation) is for resources, not annotations.
                $geometries = array_merge($geometries, $this->fetchSimpleGeometries($annotation));
            }
        }
        // Search by geometry (square/circle).
        elseif (isset($query['geo'])) {
	    $response = $this->api()->search('annotations', $query);
            $annotations = $response->getContent();
            foreach ($annotations as $annotation) {
                $geometries = array_merge($geometries, $this->fetchSimpleGeometries($annotation));
	...
	return new JsonModel([
           'status' => 'success',
            'geometries' => json_decode('{"status":"success","resourceId":81,
                "geometries":[{"id":139,"wkt":"POLYGON ((-49.141736 76.598545, -36.811645 67.474922, -31.289063 74.496413, -15.357529 78.971386, -49.141736 76.598545))",
                    "options":{"stroke":"true","color":"#e74c3c","weight":"4","opacity":"0.5","fill":"true","fillColor":"#fe57a1","fillOpacity":"0.1","clickable":"true","smoothFactor":"1","noClip":"false","lineCap":"round","lineJoin":"round","dashArray":"10, 10","dashOffset":"","fillRule":"evenodd","interactive":"true","bubblingMouseEvents":"true","pane":"overlayPane","attribution":"","maintainColor":"false","metadata":{"o:id":139,"o:is_public":true,"o:owner":{"id":3,"name":"Demo eng"},"o:created":"2018-09-13 02:17:01","o:modified":"2018-09-18 07:12:12","o:resource_template":2,"oa:motivatedBy":["highlighting"]},"right":{"edit":true,"delete":true}}},
                    {"id":150,"wkt":"POINT (17.578125 49.382373)","options":{"stroke":"true","color":"#f1c40f","weight":"4","opacity":"0.5","fill":"true","fillColor":"#fe57a1","fillOpacity":"0.1","clickable":"true","radius":"2265998.7460589935","dashArray":"10, 10","maintainColor":"false","lineCap":"round","lineJoin":"round","dashOffset":"","fillRule":"evenodd","interactive":"true","bubblingMouseEvents":"true","pane":"overlayPane","attribution":"","style":"","mediaId":"","metadata":{"o:id":150,"o:is_public":true,"o:owner":{"id":3,"name":"Demo eng"},"o:created":"2018-09-18 07:11:28","o:modified":"2019-01-18 18:24:27","o:resource_template":5,"oa:motivatedBy":["linking"],"oa:hasBody":[{"@id":"https:\/\/demo.sempiternelia.com\/cartography\/api\/items\/78","type":"resource","value_resource_id":78,"value_resource_name":"items","url":"\/cartography\/admin\/item\/78","display_title":"Coliseum","thumbnail_url":"https:\/\/demo.sempiternelia.com\/cartography\/files\/square\/a444bc8ccf9848064d04b9f77a97fc0eefd1444a.jpg","thumbnail_title":"Exterior of the Coliseum, Rome, Italy","thumbnail_type":"image\/jpeg"}]},"right":{"edit":true,"delete":true}}},
                    {"id":171,"wkt":"POLYGON ((-64.969409 68.528235, -59.3421 58.995311, -21.006055 63.233627, -54.418204 67.339861, -61.452341 68.007571, -64.969409 68.528235))","options":{"stroke":"true","color":"#e67e22","weight":"4","opacity":"0.5","fill":"true","fillColor":"","fillOpacity":"0.2","clickable":"true","smoothFactor":"1","noClip":"false","lineCap":"round","lineJoin":"round","dashArray":"","dashOffset":"","fillRule":"evenodd","interactive":"true","bubblingMouseEvents":"true","pane":"overlayPane","attribution":"","metadata":{"o:id":171,"o:is_public":true,"o:owner":{"id":3,"name":"Demo eng"},"o:created":"2018-09-27 06:22:39","o:modified":"2018-09-27 06:22:48","o:resource_template":2,"oa:motivatedBy":["highlighting"]},"right":{"edit":true,"delete":true}}},
                    {"id":193,"wkt":"POLYGON ((99.274147 -8.015716, 99.274147 1.274309, 104.374232 1.274309, 104.374232 -8.015716, 99.274147 -8.015716))","options":{"metadata":{"o:id":193,"o:is_public":true,"o:owner":{"id":1,"name":"Daniel"},"o:created":"2018-10-02 11:45:16","o:modified":"2018-10-02 11:45:16","o:resource_template":2,"oa:motivatedBy":["highlighting"]},"right":{"edit":true,"delete":true}}},
                    {"id":333,"wkt":"POINT (1.882726 48.239309)","options":{"icon":{"options":{"iconUrl":"https:\/\/api.tiles.mapbox.com\/v3\/marker\/pin-s-circle-stroked+1abc9c.png","iconSize":["25","41"],"iconColor":"#1abc9c","icon":"circle-stroked","className":"","iconAnchor":["12.5","20.5"],"popupAnchor":["0","-20.5"],"tooltipAnchor":["0","0"]},"_initHooksCalled":"true","constructor":"","initialize":"","createIcon":"","createShadow":"","_createIcon":"","_setIconStyles":"","_createImg":"","_getIconUrl":"","callInitHooks":""},"interactive":"true","keyboard":"true","title":"","alt":"","zIndexOffset":"0","opacity":"1","riseOnHover":"false","riseOffset":"250","pane":"markerPane","bubblingMouseEvents":"false","draggable":"false","autoPan":"false","autoPanPadding":["50","50"],"autoPanSpeed":"10","attribution":"","metadata":{"o:id":333,"o:is_public":true,"o:owner":{"id":1,"name":"Daniel"},"o:created":"2019-01-29 14:04:02","o:modified":"2019-01-29 14:04:08","o:resource_template":5,"oa:motivatedBy":["highlighting"]},"right":{"edit":true,"delete":true}}},
                    {"id":336,"wkt":"POINT (136.266492 45.56791)","options":{"icon":{"options":{"iconUrl":"https:\/\/api.tiles.mapbox.com\/v3\/marker\/pin-s-circle-stroked+1abc9c.png","iconSize":["25","41"],"iconColor":"#1abc9c","icon":"circle-stroked","className":"","iconAnchor":["12.5","20.5"],"popupAnchor":["0","-20.5"],"tooltipAnchor":["0","0"]},"_initHooksCalled":"true","constructor":"","initialize":"","createIcon":"","createShadow":"","_createIcon":"","_setIconStyles":"","_createImg":"","_getIconUrl":"","callInitHooks":""},"interactive":"true","keyboard":"true","title":"","alt":"","zIndexOffset":"0","opacity":"1","riseOnHover":"false","riseOffset":"250","pane":"markerPane","bubblingMouseEvents":"false","draggable":"false","autoPan":"false","autoPanPadding":["50","50"],"autoPanSpeed":"10","attribution":"","metadata":{"o:id":336,"o:is_public":true,"o:owner":{"id":1,"name":"Daniel"},"o:created":"2019-01-29 14:04:24","o:modified":"2019-01-29 14:04:30","o:resource_template":5,"rdf:value":["Vlad"]},"right":{"edit":true,"delete":true}}}]}');
        ]);
    ...
    protected function fillDataForTemplate(
        ...
        foreach ($metadata as $term => $properties) {
            ...
            // Anyway, donâ€™t process metadata that are not inside the template.
            ...
            foreach ($properties as $value) {
                switch ($dataType) {
                    ...
                    case 'resource:media':
                        ...
                        // can manage the multiple valuesâ€¦
    ...
    protected function shortResourceTemplate($templateId)
    {
        try {
            ...
            $this->logger()->err(new Message(
                'Resource template #%d doesnâ€™t exist any more. Fix settings of Cartography.', // @template
                $templateId
            ));
            return null;
        }
        ...
        foreach ($template->resourceTemplateProperties() as $templateProperty) {
            ...
            switch ($dataType) {
                ...
                case strlen($dataType) && strpos($dataType, 'customvocab:') === 0:
                    ...
                    try {
                        ...
                        $this->logger()->warn(new Message(
                            'Custom vocab #%d doesnâ€™t exist any more. Fix resource template "%s".', // @template
                    ...
                    if (empty($terms)) {
                        $this->logger()->warn(new Message(
                            'Custom vocab "%s" doesnâ€™t have terms.', // @template
                            $template->label()
                        ));
                        $input['type'] = 'text';
                        break;
            ...
            if (isset($check[$input['o:term']]) && $input['type'] !== $check[$input['o:term']]) {
                $this->logger()->warn(new Message(
                    'Short resource template doesnâ€™t support different data types for the same property. Check resource template "%s".', // @template
                    $template->label()
                ));
                return null;
            }
    ...
    protected function fetchSimpleGeometries(AbstractResourceEntityRepresentation $resource, array $query = [])
    {
        ...
        foreach ($annotations as $annotation) {
            ...
            // (source, wkt, style classâ€¦) but there may be optional properties.
            $specialProperties = [
                'oa:hasSource' => true,
                'rdf:type' => true,
                'dcterms:format' => true,
